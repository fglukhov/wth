...
(function($) {
  ...
  $.fn.featureCarousel = function (options) {
    ...
    var animateFeature = function($feature, direction)
    {
      ...
      $feature.children(".pic").animate({
        width:new_width,
        height:new_height
      },options.carouselSpeed,options.animationEasing);
      
      $feature.children(".pic").find("img").animate({
        width:new_width
      },options.carouselSpeed,options.animationEasing);
      
      $feature.find(".act-img").animate({
        opacity:act_fade
      },options.carouselSpeed,options.animationEasing);
      
      $feature.find(".descr-act .cont").animate({
        opacity:act_fade,
        height:new_height
      },options.carouselSpeed,options.animationEasing);
      
      $feature.find(".descr-inact .cont").animate({
        opacity:1-act_fade,
        height:new_height
      },options.carouselSpeed,options.animationEasing);
